...
import imageEduwork from '../../images/klass.com.png'
import Footer from './footer';

const DetailBootcampKlass = () => {
    return (
        <div>
            <div className='container mt-5'>
                <div className='row'>
                    ...
                    <div className='col-xl-8 col-md-8 col-sm-12 col-12 my-3'>
                        <div className='row'>
                            <div className='col-6'>
                                <h4 className='text-start fw-bold'>Klass.com</h4>
                                <p className='text-start'>Data Analitic Master</p>
                            </div>
                            <div className='col-6'>
                                <h4 className='text-end fw-bold'>Online</h4>
                                <p className='text-end'>Jul 2022 - Oct 2022</p>
                            </div>
                        </div>
...
export default DetailBootcampKlass