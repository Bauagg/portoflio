                            ...
                            <div className='conten-profile'>
                                <div className='row'>
                                    <div className='col-md-12 col-sm-10 col-10'>
                                        <h2 className='text-judul'>Hi, I am</h2>
                                    ...
                                    <div className='col-md-12 col-sm-2 col-2 my-3'>
                                        ...
                                        <Link to='https://www.facebook.com/profile.php?id=100009365827821&locale=id_ID' className='fs-5'><FaFacebook className='link-icon' /></Link>
                                    </div>
                                </div>
                            </div>
